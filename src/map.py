...
class MapManager:
    ...
    def __init__(self, screen, player, language):
        ...
        self.register_map("world",portals=[
            ...
            NPC("paul", nb_points=4, dialog=["Bonne aventure", "Merci pour tout", "A bientot"]),
            NPC("robin", nb_points=2, dialog=["Bonne aventura", "Merki pour tout", "A vientot"])
        ])
        ...
        self.register_map("house1", portals=[
            Portal(from_world="house1", origin_point="exit_house", target_world="world",
        ...
        self.register_map("dungeon", portals=[
            ...
            NPC("boss", nb_points=8, dialog=["Tuer!!!!", "Mon tresorrrrrr", "A votre bon coeur"])
        ])
